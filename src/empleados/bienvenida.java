...
public class bienvenida extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Bienvenido a SIGGO nomina express");

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/nomina.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (userc.equals(user.getText()) && passwordc.equals(pass.getText())){
            interfaz nomina = new interfaz();
            nomina.setVisible(true);
        dispose();
        }else {
            JOptionPane.showMessageDialog(rootPane, "El usuario o la contraseña ingresada no es correcta", "Warning", JOptionPane.WARNING_MESSAGE);
        }
